...
internal static class SulfurLauncherCommandRegistration
{
    ...
    private static void EnsureUnixPath(string binDir)
    {
        ...
        try
        {
            ...
            if (existing.Contains(line, StringComparison.Ordinal))
                return;
            File.AppendAllText(profilePath, Environment.NewLine + "# SulfurLauncher CLI command" + Environment.NewLine +
