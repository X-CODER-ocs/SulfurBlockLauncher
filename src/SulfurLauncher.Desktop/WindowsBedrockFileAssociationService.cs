...
internal static partial class WindowsBedrockFileAssociationService
{
    ...
    [
        (".mcpack", "SulfurLauncher.Minecraft.Mcpack", CommonLanguageManager.Instance.desktop_bedrockFileAssociation_mcpack.CurrentValue()),
        (".mcaddon", "SulfurLauncher.Minecraft.Mcaddon", CommonLanguageManager.Instance.desktop_bedrockFileAssociation_mcaddon.CurrentValue()),
        (".mcworld", "SulfurLauncher.Minecraft.Mcworld", CommonLanguageManager.Instance.desktop_bedrockFileAssociation_mcworld.CurrentValue()),
        (".mctemplate", "SulfurLauncher.Minecraft.Mctemplate", CommonLanguageManager.Instance.desktop_bedrockFileAssociation_mctemplate.CurrentValue())
    ];
    ...
    public static void Register()
    {
        try
        {
            ...
            foreach (var association in Associations)
            {
                ...
                application.SetValue("ApplicationName", "SulfurLauncher");
            ...
            {
                application.SetValue("FriendlyAppName", "SulfurLauncher");
