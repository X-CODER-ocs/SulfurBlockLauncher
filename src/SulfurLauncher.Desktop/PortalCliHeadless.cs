...
/// </summary>
internal static class SulfurLauncherCliHeadless
{
    ...
    public static bool TryRun(string[] args, out int exitCode)
    {
        ...
        {
            case "--version" or "-v":
                SulfurLauncherCommandRegistration.RegisterAsync().GetAwaiter().GetResult();
                PrintVersion();
                return true;
            ...
            case "help" or "--help" or "-h" or "/?" or "-?":
                SulfurLauncherCommandRegistration.RegisterAsync().GetAwaiter().GetResult();
                Write(SulfurLauncherCommandParser.GetHeadlessUsageText());
                return true;
            default:
                return false;
        }
    ...
    private static void PrintVersion()
    {
        ...
        var title = string.IsNullOrWhiteSpace(version.VersionTitle) ? "SulfurLauncher" : version.VersionTitle;
        ...
        switch (SulfurLauncherCommandParser.Parse(args, out var command, out var error))
        {
            case SulfurLauncherCliParseStatus.Error:
                Write(string.Format(
                    ...
                    Environment.NewLine, Environment.NewLine, SulfurLauncherCommandParser.GetHeadlessUsageText()));
                return 1;
