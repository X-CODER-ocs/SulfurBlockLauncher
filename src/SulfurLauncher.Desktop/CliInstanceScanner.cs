...
internal static class CliInstanceScanner
{
    ...
    public static List<CliInstanceInfo> Scan(CliFolderSnapshot folder)
    {
        ...
        return layout.Kind switch
        {
            ...
            MinecraftFolderKind.SulfurLauncherMc => ScanSulfurLauncherMc(layout.RootPath, folder),
    ...
    private static List<CliInstanceInfo> ScanSulfurLauncherMc(string rootPath, CliFolderSnapshot folder)
    {
        var result = new List<CliInstanceInfo>();
