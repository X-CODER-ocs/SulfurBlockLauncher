...
public sealed class LinuxBedrockRuntimeResolver
{
    ...
    private static string ResolvePrefixPath()
    {
        ...
        return Path.Combine(GetDataHome(), "SulfurLauncher", "Bedrock", "proton-prefix");
    }
    ...
    private static string ResolveSteamCompatPath()
    {
        ...
        var managed = Path.Combine(GetDataHome(), "SulfurLauncher", "Bedrock", "steam-client");
    ...
    private static string GetProtonInstallRoot() => Path.Combine(GetDataHome(), "SulfurLauncher", "Bedrock", "proton");
    ...
    private static string GetCacheRoot()
    {
        ...
        return string.IsNullOrWhiteSpace(cacheHome)
            ? Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), ".cache", "SulfurLauncher", "Bedrock")
            : Path.Combine(Path.GetFullPath(cacheHome), "SulfurLauncher", "Bedrock");
    }
