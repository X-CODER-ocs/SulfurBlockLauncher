...
internal static class CrashReporter
{
	...
	private unsafe static void Capture(nint exceptionPointers, string phase, bool writeMinidump = false)
	{
		try
		{
			...
			stringBuilder.AppendLine("SulfurLauncher Bedrock Preload Crash Report");
	...
	private unsafe static string DetermineOwner(nint address)
	{
		...
		if (fileName.StartsWith("SulfurLauncher.Preload", StringComparison.OrdinalIgnoreCase) || fileName.StartsWith("SulfurLauncher.XUserHook", StringComparison.OrdinalIgnoreCase))
		{
