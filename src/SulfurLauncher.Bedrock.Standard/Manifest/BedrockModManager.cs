...
namespace SulfurLauncher.Bedrock.Standard.Manifest;

public static class BedrockModManager
{
    public const int DefaultDelayMs = 5;
    public const int MaximumDelayMs = 200000;
    public static readonly string SulfurLauncherConfigFolder = Path.Combine("config", "SulfurLauncher");
    ...
    public static string GetModsFolder(BedrockInstanceConfig config) =>
        Path.Combine(config.InstancePath, SulfurLauncherConfigFolder, ModsFolderName);

    public static string GetConfigPath(BedrockInstanceConfig config) =>
        Path.Combine(config.InstancePath, SulfurLauncherConfigFolder, ConfigFileName);
