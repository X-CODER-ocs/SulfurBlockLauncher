...
public static class CredentialsService
{
    ...
    private const string CurseForgeApiKeyMetadataKey = "SulfurLauncher.CurseForgeApiKey";

    private const string MicrosoftClientIdMetadataKey = "SulfurLauncher.MicrosoftClientId";
