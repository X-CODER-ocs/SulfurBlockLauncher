...
public static class DesktopShortcutService
{
    ...
    private static string SanitizeFileName(string name)
    {
        ...
        return string.IsNullOrEmpty(result) ? "SulfurLauncher" : result;
    }
    ...
    private static string CreateWindowsShortcut(string url, string displayName, Bitmap? icon)
    {
        ...
        try
        {
            ...
            link.SetDescription(string.Format(CommonLanguageManager.Instance.desktop_launchViaSulfurLauncher.CurrentValue(), displayName));
    ...
    private static async Task<string> CreateLinuxShortcutAsync(string url, string displayName, Bitmap? icon)
    {
        ...
        builder.AppendLine($"Comment={string.Format(CommonLanguageManager.Instance.desktop_launchViaSulfurLauncher.CurrentValue(), EscapeDesktopValue(displayName))}");
