...
using Index = SulfurLauncher.Core.Module.AggregatedSearch.Index;

namespace SulfurLauncher.Core.Module.Initialize;
...
public class Config
{
    ...
    public static void Initialize()
    {
        ...
        BedrockDataPathResolver.EnsureSulfurLauncherDataDirectories();
        ...
        try
        {
            ...
            Data.ConfigEntry = string.IsNullOrWhiteSpace(configText)
                ? new ConfigEntry()
                : JsonSerializer.Deserialize<ConfigEntry>(configText, SulfurLauncherJson.Options) ?? new ConfigEntry();
        ...
        const string RESOURCE_NAME1 = "SulfurLauncher.Core.Assets.package-type.txt";
