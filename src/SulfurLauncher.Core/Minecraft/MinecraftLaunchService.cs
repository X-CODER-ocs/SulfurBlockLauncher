...
using SulfurLauncher.Core.Helpers;
...
public static class MinecraftLaunchService
{
        ...
        IReadOnlyList<string> extraGameArguments)
    {
        ...
        [
            ...
            string.Format(LogLanguageManager.Instance.launch_startupSulfurLauncherVersion.CurrentValue(), MinecraftCoreInitializer.AppVersion),
        ...
        MinecraftLogSession logSession, TaskCompletionSource processExit, Action<Process> processStarted)
    {
        ...
        {
            var text = $"[SulfurLauncher/Bedrock] {message}";
...
public sealed class SulfurLauncherGameArgumentParser : IArgumentParser
{
    private readonly IArgumentParser _inner;
    private readonly IReadOnlyList<string> _extraGameArguments;

    public SulfurLauncherGameArgumentParser(IArgumentParser inner, IReadOnlyList<string> extraGameArguments)
    {
        _inner = inner;
