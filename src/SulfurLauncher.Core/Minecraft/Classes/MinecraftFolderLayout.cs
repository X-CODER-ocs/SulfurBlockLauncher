    ...
    string DisplayName)
{
    ...
    public bool SupportsInstallation => Kind == MinecraftFolderKind.SulfurLauncherMc;
    ...
    private static bool IsSulfurLauncherMcRoot(string path)
    {
    ...
    public static bool TryFindSulfurLauncherMcRoot(string path, out string root)
    {
        ...
        while (current != null)
        {
            if (IsSulfurLauncherMcRoot(current.FullName))
            {
    ...
    public static MinecraftFolderLayout Detect(string path)
    {
        ...
        if (IsSulfurLauncherMcRoot(selected))
            return new MinecraftFolderLayout(MinecraftFolderKind.SulfurLauncherMc, selected, selected, "SulfurLauncher MC");
        if (TryFindSulfurLauncherMcRoot(selected, out var portalMcRoot))
            return new MinecraftFolderLayout(MinecraftFolderKind.SulfurLauncherMc, portalMcRoot, portalMcRoot, "SulfurLauncher MC");
    ...
    public static MinecraftFolderLayout FromFolderKind(MinecraftFolderKind kind, string path)
    {
        ...
        var displayName = kind switch
        {
            ...
            MinecraftFolderKind.SulfurLauncherMc => "SulfurLauncher MC",
