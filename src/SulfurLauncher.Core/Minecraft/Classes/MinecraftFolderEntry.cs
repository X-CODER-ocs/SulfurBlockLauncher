...
public partial class MinecraftFolderEntry : ObservableObject, IEquatable<MinecraftFolderEntry>
{
    ...
    private async Task RefreshDataAsync()
    {
        ...
        try
        {
            var freshCount = await Task.Run(async () =>
            {
                try
                {
                    ...
                    return layout.Kind switch
                    {
                        ...
                        MinecraftFolderKind.SulfurLauncherMc => CountSulfurLauncherMcInstances(layout.RootPath) +
                                                        CountInstances(
    ...
    private static int CountSulfurLauncherMcInstances(string rootPath)
    {
