...
public class BedrockHelper
{
    ...
    public static readonly string ConfigFolder = Path.Combine("config", "SulfurLauncher");
    private static readonly string LegacyConfigFolder = Path.Combine("config", "SulfurLauncher.Desktop");
