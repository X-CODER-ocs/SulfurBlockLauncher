...
{
    private const string BaseContentUrl = "https://mcnews.cangcang.cc/v2/";
    ...
    private static async Task<NewsDetail?> FetchAsync(NewsEntry entry)
    {
        ...
        try
        {
            ...
            var content = JsonSerializer.Deserialize<NewsContentResponse>(json, SulfurLauncherJson.Options);
