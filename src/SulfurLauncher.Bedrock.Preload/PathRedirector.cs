...
internal static class PathRedirector
{
    ...
    public static string IsolationFolder { get; } = @"config/SulfurLauncher/isolation";
    ...
    private static void InitializeBaseDirectory(ConfigManager config)
    {
        ...
        BaseDirectory = config.GetConfig("folderPolicyString") switch
        {
            ...
            "portal" => ResolveSulfurLauncherDirectory(exeDir),
            _ => BaseDirectory,
        };
    ...
    private static string ResolveSulfurLauncherDirectory(string exeDir)
    {
