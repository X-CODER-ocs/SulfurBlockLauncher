...
using AuthServer = SulfurLauncher.Core.Minecraft.Classes.AuthServer;
using EditAuthServerViewModel = SulfurLauncher.Views.Components.Operations.Account.EditAuthServerViewModel;
