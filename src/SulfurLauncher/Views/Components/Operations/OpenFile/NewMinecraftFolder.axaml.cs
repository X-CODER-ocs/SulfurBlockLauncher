...
namespace SulfurLauncher.Views.Components.Operations.OpenFile;
...
public partial class NewMinecraftFolderViewModel : ObservableObject, IDialogContext
{
    ...
    partial void OnFolderPathChanged(string? value)
    {
        ...
        if (layout.Kind == MinecraftFolderKind.Standard && IsDirectoryEmpty(folderPath))
            layout = MinecraftFolderLayout.FromFolderKind(MinecraftFolderKind.SulfurLauncherMc, folderPath);
