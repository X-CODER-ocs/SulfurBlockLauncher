...
using SulfurLauncher.Core.App.Helpers;
...
public partial class MinecraftInstallationViewModel : ObservableObject, INotifyDataErrorInfo, IDialogContext
{
    ...
    {
        MinecraftInstallationTasks.WriteSulfurLauncherMcMinimalInstanceJson(instanceDirectory, instanceId, vanillaId);
    }
    ...
    private bool VersionDirectoryExists(string id)
    {
        return SelectedMinecraftFolder is not null &&
               Directory.Exists(SelectedMinecraftFolder.DetectedLayout.Kind == MinecraftFolderKind.SulfurLauncherMc
