...
public partial class CreateInstanceDialogViewModel : ObservableObject, IDialogContext, IDisposable
{
    ...
    private static readonly string DefaultIconResource = "SulfurLauncher.Core.Assets.McIcons.01_grass_block_side.png";
    ...
    private string GetSuggestedIconResource()
    {
        ...
        if (SelectedLoader?.Kind is { } kind)
            return kind switch
            {
                LoaderKind.Fabric => "SulfurLauncher.Core.Assets.McIcons.05_FabricIcon.png",
                LoaderKind.Forge => "SulfurLauncher.Core.Assets.McIcons.06_ForgeIcon.png",
                LoaderKind.NeoForge => "SulfurLauncher.Core.Assets.McIcons.07_NeoForgeIcon.png",
                LoaderKind.Quilt => "SulfurLauncher.Core.Assets.McIcons.09_QuiltIcon.png",
                _ => DefaultIconResource
            };

        if (IsOptiFineSelected)
            return "SulfurLauncher.Core.Assets.McIcons.08_OptiFineIcon.png";

        if (SelectedVersion?.Value is VersionManifestEntry vanilla &&
            string.Equals(vanilla.Type, "snapshot", StringComparison.OrdinalIgnoreCase))
            return "SulfurLauncher.Core.Assets.McIcons.02_crafting_table_front.png";
    ...
    private string? Validate()
    {
        ...
        var instanceDirectory = SelectedMinecraftFolder.DetectedLayout.Kind == MinecraftFolderKind.SulfurLauncherMc
