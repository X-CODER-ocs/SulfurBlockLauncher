...
using SulfurLauncher.Core.Minecraft.Modpack;
...
public partial class ModpackExportDialogViewModel : ObservableObject, IDialogContext
{
    ...
    public ModpackExportDialogViewModel(MinecraftInstance instance)
    {
        ...
        BuildOptions();
        IncludeSulfurLauncherIcon = CanExportSulfurLauncherIcon;
    }
    ...
    [ObservableProperty] public partial bool IncludeSulfurLauncherSettings { get; set; }
    [ObservableProperty] public partial bool IncludeSulfurLauncherIcon { get; set; }
    ...
    public bool CanExportSulfurLauncherIcon => _instance.GetExportIconPath() != null;
    ...
    private void Confirm()
    {
        ...
        var options = new ModpackExportOptions
        {
            ...
            IncludeSulfurLauncherSettings = IncludeSulfurLauncherSettings,
            IncludeSulfurLauncherIcon = IncludeSulfurLauncherIcon
        };
