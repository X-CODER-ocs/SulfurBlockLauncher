...
using SulfurLauncher.Module.Initialize;
using SulfurLauncher.Views;
...
public partial class App : Application
{
    ...
    public override void OnFrameworkInitializationCompleted()
    {
        ...
        if (BedrockPackagePath == null)
        {
            SulfurLauncherCommandQueue.ExecutionHandler = SulfurLauncherCommandExecutor.ExecuteAsync;
    ...
    private void OnActivated(object? sender, ActivatedEventArgs e)
    {
        ...
        if (SulfurLauncherCommandParser.Parse([uri.ToString()], out var command, out var error) ==
            SulfurLauncherCliParseStatus.Command && command is not null)
            SulfurLauncherCommandQueue.Enqueue(command);
    ...
    private async void Function(object? sender, RoutedEventArgs e)
    {
        ...
        finally
        {
            ...
            SulfurLauncherCommandQueue.MarkUiLoaded();
